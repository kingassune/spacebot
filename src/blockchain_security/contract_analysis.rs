...
/// Supported blockchain platforms for contract analysis.
...
impl ContractAnalyzer {
    ...
    /// Analyse a contract source file, dispatching to the language-specific analyser.
...
/// Analyse Solidity source for common vulnerability patterns.
...
/// Analyse Rust-based contracts (Solana programs, CosmWasm).
...
/// Analyse Move-based contracts (Aptos, Sui).
