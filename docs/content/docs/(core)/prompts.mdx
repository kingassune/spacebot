...
James uses a bundled template system powered by [MiniJinja](https://github.com/mitsuhiko/minijinja) (a Rust implementation of Jinja2). All system prompts are embedded in the binary at compile time and support runtime variable substitution.
