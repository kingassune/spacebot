---
title: Philosophy
description: Why James is built in Rust and what makes it different from other AI systems.
---
...
James isn't a chatbot. It's an orchestration layer for autonomous AI processes -- channels, branches, workers, a compactor, a cortex -- all running concurrently, all delegating to each other, all sharing memory. This is closer to an operating system than a web app.
