---
title: Slack Setup
description: Connect James to Slack.
---

# Slack Setup

Connect James to your Slack workspace. Takes about 5 minutes.
...
You'll be prompted to create an **App-Level Token**. Give it a name (e.g. "james") and add the `connections:write` scope. Click **Generate**.
...
These tell Slack which message events to send to James. Without them, the bot won't see messages in the corresponding channel types.
