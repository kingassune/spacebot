...
How James extends agent capabilities with reusable skills from skills.sh.
...
James's skill system is fully compatible with [skills.sh](https://skills.sh) — the open agent skills ecosystem. Install any skill from the registry or create your own.
...
james skill add vercel-labs/agent-skills --instance

# Install to a specific agent
james skill add remotion-dev/skills --agent my-agent
```

Install from a `.skill` file:

```bash
james skill install path/to/skill.skill
```
...
```bash
mkdir -p ~/.james/agents/my-agent/workspace/skills/my-skill
cd ~/.james/agents/my-agent/workspace/skills/my-skill
```
...
|-------|-------------|---------|
| `vercel-labs/agent-skills` | React best practices, web design guidelines | `james skill add vercel-labs/agent-skills` |
| `anthropics/skills/pdf` | PDF creation, editing, extraction | `james skill add anthropics/skills/pdf` |
| `remotion-dev/skills` | Video generation with Remotion | `james skill add remotion-dev/skills` |
| `supabase/agent-skills` | Postgres best practices for Supabase | `james skill add supabase/agent-skills` |
...
```bash
ls -la ~/.james/agents/my-agent/workspace/skills/my-skill/
...
```bash
rm -rf ~/.james/agents/my-agent/workspace/skills/conflicting-skill
```
