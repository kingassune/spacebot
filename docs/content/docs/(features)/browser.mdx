...
Browser automation for James workers via headless Chrome. Workers can navigate websites, interact with page elements, take screenshots, and extract content. Built on [chromiumoxide](https://github.com/mattsse/chromiumoxide), which drives Chrome over the DevTools Protocol (CDP).
...
```
~/.james/agents/main/data/screenshots/screenshot_20260212_143052_123.png
```
